-- Align Work by Category / Sector with Total Pipeline active scope
-- (Open status; exclude Lose / On Hold). Sector uses LEFT JOIN so
-- pipelines without a customer still count (as Unspecified).
